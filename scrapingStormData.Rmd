...
buoyLocs2000 <- mutate(buoyLocs2000, distToStorm = 
                         distGeo(stormCoords, c(buoyLocs2000$Longitude, 
                                                buoyLocs2000$Latitude)))
  filter(distGeo(stormCoords, c(Longitude, Latitude)) <= 1e5)
